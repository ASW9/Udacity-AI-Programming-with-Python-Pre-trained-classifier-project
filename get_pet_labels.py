...
def get_pet_labels(image_dir):
    ...
    # function
    ## code completed using get_pet_labels_hints.py
    ...
    for idx in range(0, len(in_files), 1):
       ...
       if in_files[idx][0] != ".":
            ...
            #THIS CODE IS TAKEN AND EDITED FROM "CREATING PET LABELS" TUTORIAL PAGE
            ...
            pet_label_name = pet_label_name.strip()
            pet_label_name_list = list(pet_label_name.split(" "))
            ...
            if in_files[idx] not in results_dic:
                results_dic[in_files[idx]] = pet_label_name_list
